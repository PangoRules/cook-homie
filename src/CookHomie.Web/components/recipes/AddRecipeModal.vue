...
<script setup lang="ts">
  ...
  const validate = () => {
    ...
    if (form.prepMinutes < 1) {
      errors.prepMinutes = "Must be at least 1 minute";
      isValid = false;
    } else errors.prepMinutes = "";
    if (form.cookMinutes < 1) {
      errors.cookMinutes = "Must be at least 1 minute";
      isValid = false;
  ...
  const resetForm = () => {
    ...
    form.instructions = "";
    form.tags = [];
    form.ingredients = [emptyIngredient()];
    errors.name = "";
    errors.instructions = "";
    errors.ingredients = "";
    errors.prepMinutes = "";
